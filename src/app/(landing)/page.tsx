				...
				<div className="w-full md:max-w-2xl rounded-lg overflow-hidden">
					<AspectRatio ratio={16 / 9}>
						<Image
							...
							alt="Preview"
							fill
							className="border-[2px] border-blue-500/70 
...
const Headline = () => {
	return (
		<div>
			<h1 className="text-4xl lg:text-5xl font-extrabold text-pretty text-center tracking-tight leading-[1.15]">
				Engage your audience like never before
			</h1>
			<p className="text-muted-foreground text-center leading-relaxed mt-2 lg:mt-4">
				Dory offers a suite of interactive features to keep your audience
				engaged and provide ypu with valueable insight
			</p>
		</div>
	);
};
			...
			{valuePropositions.map(({ title, icon: Icon, description }) => (
				<div key={title} className="flex flex-col items-start gap-y-2">
					<div className="inline-flex items-center gap-x-2">
						<Icon size={25} className="stroke-blue-600" />
